...
public class Mp5RifleScript : MonoBehaviour
{
    ...
    private int numberOfBulletsLeft = 30;
    ...
    {
        if (timeBetweenShots >= 10 && numberOfBulletsLeft > 0 && isShooting)
        {
            timeBetweenShots = 0;
            numberOfBulletsLeft--;
            Shoot();
